...
| 📘 [**Days 31–35: Mechanical Engineering & Preliminary Sizing**](file:///home/ishan/ros2_ws/src/devotics_arm_description/docs/DAY_31_TO_35_MECHANICAL_ENGINEERING_AND_BOM.md) | Research Manipulator Classification, Torque Reality Check, Backlash Math, Preliminary BOM | Audited actuator margins (J2 marginal, J3/J4 undersized); analyzed stepper torque-speed degradation at $200-300\text{ RPM}$; proved backlash error vs $\pm 1\text{ mm}$ reach; **Procurement locked pending Stage A-D CAD validation**. |
