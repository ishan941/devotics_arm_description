...
| 📘 [**Days 31–35: Mechanical Engineering & BOM**](file:///home/ishan/ros2_ws/src/devotics_arm_description/docs/DAY_31_TO_35_MECHANICAL_ENGINEERING_AND_BOM.md) | Requirements Spec, Human-Arm Geometry, Torque Physics, Gearbox Ratios, BOM Costing | Solved the shoulder torque problem ($20\text{ Nm}$ needed vs $0.45\text{ Nm}$ raw motor); selected 20:1 planetary reduction; finalized ESP32 + 24V BOM (~$226 USD); **Passed Stage Gate 2**! |
